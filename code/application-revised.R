...
source("./code/pl-geom-left-trunc-app-formulas.R")
...
if( CI_upp > 1){print("check")} #may need to update for log CIs
...
for(j in k){
  ...
  nk = append(nk, sum( obs_data$Xi == j) )
}
